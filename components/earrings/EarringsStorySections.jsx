    ...
    <div className="mt-14 space-y-16 md:space-y-20">
      ...
      <section aria-labelledby="earrings-benefits-heading">
        <SectionShell>
          ...
          <ul className="mx-auto mt-10 max-w-[800px] space-y-4 border border-[#211c17] bg-[#141414] px-6 py-8 font-serif text-[16px] leading-[1.75] text-[#b8b2a6] md:px-10 md:text-[17px] md:leading-[1.8]">
          ...
          <p className="mx-auto mt-10 max-w-[720px] text-center font-serif text-[17px] leading-[1.85] text-[#b8b2a6] md:text-[19px]">
            {earringsBenefitsClosing}
          </p>
        </SectionShell>
      </section>
