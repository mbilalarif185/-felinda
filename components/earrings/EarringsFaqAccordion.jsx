...
import { earringsFaqItems, earringsFaqTitle } from "@/lib/content/earrings-page";

export default function EarringsFaqAccordion() {
  const [openIndex, setOpenIndex] = useState(null);

  return (
    <section className="mt-14 border-t border-[#ece1dc] pt-10" aria-labelledby="earrings-faq-heading">
      <h2
        id="earrings-faq-heading"
