...
const prose =
  ...
  "[&_code]:rounded [&_code]:bg-white/5 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.9em] [&_code]:text-luxeGoldSoft " +
  ...
  "[&_pre]:my-8 [&_pre]:overflow-x-auto [&_pre]:rounded-xl [&_pre]:border [&_pre]:border-line [&_pre]:bg-noir [&_pre]:p-4 [&_pre]:text-sm [&_pre]:text-white " +
