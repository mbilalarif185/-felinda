    ...
    <div className="mt-14 space-y-16 md:space-y-20">
      ...
      <section aria-labelledby="bespoke-why-heading">
        <SectionShell>
              ...
              return (
                <>
                  <li className="md:col-span-2">
                    <div className="h-full overflow-hidden rounded-[22px] border border-[#26221e] bg-gradient-to-br from-[#141414] via-[#121212] to-[#161310] shadow-[0_16px_40px_rgba(110,90,80,0.06)]">
                      <div className="flex flex-col gap-6 p-7 md:flex-row md:items-start md:gap-10 md:p-10">
                        <div className="flex h-[4.5rem] w-[4.5rem] shrink-0 items-center justify-center rounded-2xl border border-[#3a301c] bg-white/[0.05] text-[#d4af37] shadow-sm">
                          <FeaturedIcon className="h-9 w-9" strokeWidth={1.35} aria-hidden />
                        </div>
                        <div className="min-w-0 flex-1 text-left">
                          <h3 className="font-serif text-[26px] font-light leading-snug tracking-[-0.02em] text-[#f3efe6] md:text-[32px]">
                            {featured.title}
                          </h3>
                          <p className="mt-4 max-w-[720px] font-serif text-[16px] leading-[1.75] text-[#b8b2a6] md:text-[17px]">
                            {featured.text}
                          </p>
                        </div>
                      </div>
                  ...
                  {rest.map((item, i) => {
                    ...
                    return (
                      <li key={item.title}>
                        <div className="group flex h-full min-h-[220px] flex-col rounded-[18px] border border-[#26221e] bg-[#141414] p-6 shadow-[0_6px_22px_rgba(110,90,80,0.04)] transition duration-300 hover:border-[#dfc9c0] hover:shadow-[0_12px_32px_rgba(110,90,80,0.07)]">
                          <div className="flex items-center justify-between gap-3">
                            ...
                            <span
                              className="font-serif text-[11px] tabular-nums text-[#d4af37] opacity-80"
                              aria-hidden
                            >
          ...
          <p className="mx-auto mt-12 max-w-[800px] border-t border-[#26221e] pt-10 text-center font-serif text-[17px] leading-[1.85] text-[#b8b2a6] md:text-[19px]">
            ...
            {bespokeProcess.steps.map((step, index) => (
              <li key={step.title}>
                <div className="flex h-full flex-col rounded-[16px] border border-[#26221e] bg-[#141414] px-5 py-6 text-center shadow-[0_4px_18px_rgba(110,90,80,0.04)] md:px-4 md:py-7">
                  ...
                  <p className="mt-3 flex-1 text-center text-[14px] leading-relaxed text-[#b8b2a6] md:text-[15px]">
                    {step.text}
                  </p>
                </div>
              </li>
