      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl gap-14 px-6 py-20 lg:grid-cols-2 lg:px-10 lg:py-28">
            <div className="flex flex-col justify-center">
              ...
              <p className="auréa-sans mt-6 max-w-xl text-lg leading-8 text-muted">
               Auréa is a private atelier where fine jewelry is conceived around one person, one story, and a moment meant to endure. We do not design collections. We design for you.
              </p>
        ...
        <section className="mx-auto grid max-w-7xl gap-14 px-6 py-24 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          ...
          <div className="flex flex-col justify-center">
            ...
            <h2 className="auréa-serif max-w-xl text-4xl leading-tight lg:text-6xl">
              Jewelry That Holds What Words Cannot.
            </h2>
            <p className="auréa-sans mt-6 max-w-2xl text-lg leading-8 text-muted">
             At Auréa, every piece begins with you.
...
We do not follow trends, and we do not design for the masses. Each creation is conceived for one — shaped by intention, guided by emotion, and brought to life through uncompromising craftsmanship.
            ...
            <p className="auréa-sans mt-4 max-w-2xl text-lg leading-8 text-muted">
...
It is made to be remembered — an extension of who you are, and a moment that endures.
            ...
            <div className="mt-8">
              <Link
                href="/about"
                className="auréa-sans inline-block rounded-full border border-line bg-white px-6 py-3.5 text-sm font-medium tracking-[0.04em] text-ink transition hover:bg-shell"
              >
                Explore the Auréa Story
              </Link>
            </div>
          </div>
        </section>
              ...
              {creations.map((item) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col border-t border-line/50 bg-white px-6 pb-6 pt-6">
                    <div className="auréa-sans text-[11px] font-medium uppercase tracking-[0.2em] text-muted">
                      {item.tag}
                    </div>
                    <h3 className="auréa-serif mt-3 text-2xl leading-[1.15] tracking-[-0.01em] text-ink md:text-[1.65rem]">
                      {item.title}
                    </h3>
                    <p className="auréa-sans mt-3.5 flex-1 text-[15px] leading-[1.65] text-muted">
                      {item.desc}
                    </p>
                    <Link
                      href={item.href}
                      className="auréa-sans mt-7 inline-flex w-full shrink-0 items-center justify-center rounded-full border border-line bg-white px-5 py-3 text-sm font-medium tracking-[0.04em] text-ink transition hover:border-rose/40 hover:bg-shell"
                    >
                      View collection
                    </Link>
                  </div>
        ...
        <section className="mx-auto max-w-7xl px-6 py-24 lg:px-10">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="auréa-sans mt-5 text-lg leading-8 text-muted">
                ...
                The Auréa process is designed to feel the opposite of a transaction. It unfolds at the pace of trust, guided by conversation, intention, and detail. It is only complete when every element feels exactly right — because nothing leaves the atelier until it belongs fully to you.
        ...
        <section className="bg-white py-24">
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <div className="mb-12 text-center">
             ...
             If you are unsure where to begin, each Auréa category serves as a doorway into the same intimate experience — one that concludes with a piece made exclusively for you
            </p>
            </div>
                  ...
                  <div className="relative z-0">
                    <div className="relative h-[420px] overflow-hidden rounded-[1.5rem] border border-white">
                      ...
                      <div className="pointer-events-none absolute inset-x-0 bottom-0 min-w-0 p-5 text-white sm:p-7">
                        <div className="auréa-sans text-xs uppercase tracking-[0.22em] text-white/80">
                          {item.subtitle}
                        </div>
                        <div
                          className="auréa-serif mt-3 w-full max-w-full whitespace-nowrap text-[clamp(1rem,0.75vw+0.8rem,1.65rem)] leading-[1.12] tracking-[-0.015em]"
                          title={item.title}
                        >
                          {item.title}
                        </div>
                        <span className="auréa-sans mt-5 inline-flex w-fit rounded-full border border-white/60 bg-white/10 px-5 py-3 text-sm tracking-[0.04em] text-white backdrop-blur transition group-hover:bg-white/20 sm:mt-6">
                          Explore
                        </span>
                      </div>
                    </div>
