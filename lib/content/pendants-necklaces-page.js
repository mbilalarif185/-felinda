...
export const pendantsNecklacesIntroParagraphs = [
  "From delicate solitaires to layered chains and statement collars, each Auréa neckpiece is designed to sit close, catch light, and carry meaning.",
...
export const pendantsNecklacesWhyTitle = "Why choose Auréa for custom necklaces and pendants";

export const pendantsNecklacesWhyLead =
  "Auréa brings true versatility and emotional depth to necklace customization. We go beyond standard designs to create pieces that reflect your personality, style, and life chapters. Here is what makes our bespoke pendants and necklaces special:";
...
export const pendantsNecklacesProcessSubtitle =
  "Crafting a bespoke pendant or necklace with Auréa is a collaborative and rewarding experience:";
...
export const pendantsNecklacesJourneyCta = {
  ...
  body: "Your story, your milestones, and your style deserve a neckpiece as unique and beautiful as you are. Quiet daily elegance, vibrant colour, classic sparkle, or bold modern flair: Auréa is ready to make it real.",
