...
export const bespokeDocSeoStrategyParagraphs = [
  ...
  "On-page SEO tips:",
  'Update page title: "Bespoke Jewellery Malaysia | Custom Jewellery by Auréa"',
  'Meta description: 150-160 chars, e.g., "Discover exquisite bespoke jewellery in Malaysia at Auréa. Create timeless custom pieces with pink gemstones in rose gold — feminine, romantic, and uniquely yours. Book your consultation today."',
  ...
  "Your content should differentiate Auréa through feminine elegance, nature-inspired romance, pink gemstones + rose gold, and a seamless bespoke journey while matching the emotional, customer-centric tone of top players.",
];

/** Doc: "Page Title" (line 28) */
export const bespokeDocumentPageTitle =
  "Bespoke Jewellery Malaysia | Custom Jewellery & Personalized Designs by Auréa";

/** Doc: "Meta Description" (line 30) */
export const bespokeDocumentMetaDescription =
  "Create your dream bespoke jewellery in Malaysia with Auréa. From romantic rose gold pieces with luminous pink gemstones to fully custom designs inspired by nature, our expert artisans craft timeless, feminine jewellery that's uniquely yours. Book a virtual or in-person consultation today.";
...
export const bespokeDocHeroIntroParagraphs = [
  "Every piece of bespoke jewellery at Auréa tells a story of timeless romance and feminine elegance. Inspired by nature's finest blooms, our custom creations feature luminous pink gemstones set in radiant rose gold, blending effortless beauty with personal meaning.",
  "Whether you're looking for a one-of-a-kind engagement ring, a meaningful pendant, or a signature piece that reflects your style, our custom jewellery Malaysia service turns your vision into reality. Designed and handcrafted with passion in Malaysia, each Auréa piece is as unique as the woman who wears it.",
...
/** Doc: "Why Choose Auréa for Bespoke Jewellery in Malaysia (H2)" (line 38) */
export const bespokeDocWhyTitle = "Why Choose Auréa for Bespoke Jewellery in Malaysia";

/** Doc: line 39 */
export const bespokeDocWhyLead =
  "At Auréa, we believe jewellery should be more than beautiful, it should be personal. What sets our custom made jewellery apart:";
