...
export const customRingsPageMeta = {
  absoluteTitle: "Get Custom Rings in Malaysia | Bespoke Fine Jewelry",
  description:
    "Design your own custom ring in Malaysia with Auréa, engagement, wedding & statement rings handcrafted in gold, platinum & rare gemstones. Consult us now!",
  keywords: [
    "Custom Rings Malaysia",
    "bespoke rings Petaling Jaya",
    "handmade rings KL",
    "custom ring design Selangor",
    "rose gold custom ring",
    "gemstone rings Kuala Lumpur",
  ],
};

/** PageHero H1 is “Custom Rings”; this line sits beneath it. */
export const customRingsHeroSubtitle =
  "Shaped around your moment and your promise";

/** Intro card display headline (PageHero holds the page H1). */
export const customRingsIntroHeadline = {
  beforeScript: "Shaped around",
  script: "your moment and your promise",
};

export const customRingsIntroParagraphs = [
  "Every custom ring at Auréa begins with a moment, a person, or a promise. Crafted with intention and lasting craftsmanship, each piece is designed to endure a lifetime.",
  "From engagement and wedding rings to promise and stacking designs, our bespoke service in Malaysia turns your story into something deeply personal.",
  "Start with your idea. We will shape it into reality.",
];
...
/** Why Auréa — section title (document H2, label stripped). */
export const customRingsWhyTitle = "Why choose Auréa for custom rings";

export const customRingsWhyLead =
  "In Malaysia’s competitive jewellery scene, Auréa stands apart by offering soft, romantic custom rings that celebrate feminine elegance rather than only classic diamonds.";
...
export const customRingsProcessSubtitle =
  "Creating custom made rings with Auréa is a joyful, collaborative journey.";
...
export const customRingsFaqItems = [
  {
    ...
    answer:
      "Prices for Auréa custom rings vary based on gemstone size, carat weight, and design complexity. We offer transparent pricing with no hidden fees and options for different budgets.",
  },
  {
...
export const customRingsClosingBody =
  "Begin your custom rings journey with Auréa today. Let our team help you create a piece filled with intention, light, and timeless romance.";
