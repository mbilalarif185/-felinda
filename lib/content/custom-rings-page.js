...
export const customRingsWhyPillars = [
  {
    ...
    body: "From halo styles and floral motifs to minimalist bands — each concept is built around you.",
  },
  {
...
export const customRingsFaqItems = [
  ...
  },
  {
    ...
    answer:
      "Yes — our signature style features radiant rose gold paired with luminous pink gemstones such as morganite, pink sapphire, and pink tourmaline for a soft, feminine aesthetic.",
  },
  {
    question: "Can I create a custom engagement ring?",
    answer:
      "Absolutely. Many clients design romantic custom engagement rings with pink centre stones or delicate rose gold settings that feel unique and heartfelt.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. Whether you are in Penang, Johor, Sabah, Sarawak, or even overseas, we provide convenient virtual consultations.",
  },
];
