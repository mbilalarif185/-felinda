...
export const customRingsPageMeta = {
  ...
  description:
    "Design your own custom ring in Malaysia with Felinda, engagement, wedding & statement rings handcrafted in gold, platinum & rare gemstones. Consult us now!",
  keywords: [
...
export const customRingsIntroParagraphs = [
  "Every custom ring at Felinda begins with a moment, a person, or a promise. Crafted with intention and lasting craftsmanship, each piece is designed to endure a lifetime.",
